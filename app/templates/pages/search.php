...
ul.tabs li.current{background:#DD3333;color:#FFF}
...
.hero-search form .search-submit:hover{background-color:#DD3333}
.wpas-field,.wpas-field.wpas-submit-field{width:100%}
.advanced{width:96%;margin:10px 2%;font-weight:700;line-height:30px;color:#DD3333;font-size:1rem;white-space:nowrap;text-align:left}
.advanced i{border:1px solid #DD3333;border-radius:20px;height:22px;width:22px;line-height:20px;font-size:14px;display:inline-block;text-align:center;margin-left:5px}
...
.alert {margin:25px 0;padding:20px 0;background:#DD3333;color:#000;text-align:center;}
</style>
