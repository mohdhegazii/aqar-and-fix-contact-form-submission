...
function get_my_property_header()
{
  ...
  $property_city = featured_city_tag($property_id,'property_city');

  $property_city_name = get_property_city_name($property_id);
  $property_city_link = get_property_city_link($property_id);

  ?>

  <?php get_properties_top_search(); ?>
	...
	<div class="unit-hero">
		<div class="container">
            ...
            <div class="breadcrumbs" itemscope="" itemtype="http://schema.org/BreadcrumbList">
              ...
              <?php if ( $property_city_name !== NULL AND $property_city_name != '' ): ?>
                <span itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                  <a class="breadcrumbs__link" href="<?php echo $property_city_link; ?>" itemprop="item">
                    <span itemprop="name"><?php echo esc_html( $property_city_name ); ?></span></a>
                  <meta itemprop="position" content="<?php echo $i; $i++; ?>">
                </span>
                <span class="breadcrumbs__separator">›</span>
              <?php endif; ?>
              ...
              <?php endif; ?>
						...
						<div class="location"><i class="icon-location"></i> <?php echo $property_city; ?></a></div>
						<!--unit details-->
				...
				<div class="col-md-4">
					<div class="unit-price"><span><?php echo number_format($price); ?></span> <?php get_text('ج.م','EGP'); ?></div>
				</div>
			</div>
		</div>
	</div>
...
function get_my_property_main()
{
  ...
  $location = carbon_get_post_meta( $property_id, 'jawda_location' );
  ...
  $post_type = featured_city_tag($property_id,'post_type');
    ...
    <div class="">
        ...
        <div class="unit-box2">
          <div class="unit-img2">
            ...
            <div class="unit-tag2"><?php echo $property_status; ?><?php echo $post_type; ?></div>
          </div>

          <div class="unit-data2">
            <div class="unit-title2"><a href="<?php echo $url; ?>"><?php echo $title; ?></a></div>
            <span class="unit-location2"><i class="icon-location"></i> <?php echo $property_city; ?></span>
